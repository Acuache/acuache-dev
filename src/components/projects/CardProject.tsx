...
export function CardProject({ id, title, description, skills, links, colorBG }: ProjectProps) {
  ...
  return (
    <article className='project-card flex flex-col border group overflow-hidden rounded-lg' >
            ...
            })}
            {
              skills.length > 3 && (
                <div className='ml-1 flex gap-1.5' aria-hidden="true">
                  <div className='size-2 bg-white rounded-full relative animate-none group-hover:animate-dot-bounce [animation-delay:0ms] group-hover:bg-st/80' aria-hidden="true"></div>
                  <div className='size-2 bg-white rounded-full relative animate-none group-hover:animate-dot-bounce [animation-delay:300ms] group-hover:bg-st/80' aria-hidden="true"></div>
                  <div className='size-2 bg-white rounded-full relative animate-none group-hover:animate-dot-bounce [animation-delay:600ms] group-hover:bg-st/80' aria-hidden="true"></div>
                </div>
              )
            }
          </div>
